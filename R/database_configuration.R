...
#' @description Creates the corresponding S3 object containing the database configuration details
#'
...
#'
#' @return Returns an S3 object of different class, depending on the type of database selected.
#'
...
#' passed to \link{db_load}, it will create a data frame in the global environment
...
#' \code{"mdb_csv"} is passed to \link{db_load}, it will create a csv file in the
...
#' database. When the object \code{"mdb_SQLite"} is passed to \link{db_load},
