#' Fake data simulating organizations from Mexico
#'
#' A fake dataset simulating organizations of Mexico to test the functions.
#' It results in simple and fast queries and maps.
#'
